...
const STRINGS = {
  en: {
    ...
    install: {
      ...
      iosSafari: 'Tap the Share button in your browser, then choose “Add to Home Screen”.',
      androidChrome: 'Open your browser’s menu (⋮) and tap “Install app” (or “Add to Home screen”).',
      desktop: 'Click the install icon in the address bar, or open your browser’s menu and choose “Install Defend the Crystal”.',
    ...
    hud: {
      ...
      dragHint: 'Drop {name} on a green tile to build it',
      placeClickHint: 'Click a tile to place {name} — tap here to cancel',
      placeTapHint: 'Tap a tile to preview {name}, tap it again to confirm — tap here to cancel',
    ...
    dlg: {
      ...
      duvidas: {
        0: 'Welcome, hero! I am Theo, keeper of this sanctuary. Up those stairs, past the colonnade, lies the crystal we all live to protect.',
  ...
  pt: {
    ...
    install: {
      ...
      iosSafari: 'Toque no botão Compartilhar do navegador e escolha “Adicionar à Tela de Início”.',
    ...
    hud: {
      ...
      dragHint: 'Solte {name} sobre um tile verde para construir',
      placeClickHint: 'Clique num tile para posicionar {name} — toque aqui para cancelar',
      placeTapHint: 'Toque num tile para ver {name} e toque de novo para confirmar — toque aqui para cancelar',
    ...
    dlg: {
      ...
      duvidas: {
        0: 'Bem-vindo, herói! Eu sou Theo, guardião deste santuário. Subindo aquelas escadas, além da colunata, está o cristal que vivemos para proteger.',
